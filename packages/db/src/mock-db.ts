...
const mockEntities: Record<string, EntityMetadata> = {
  ...
  "experience.capgemini-japan": {
    ...
    role: "Senior Director & Head of Digital Engineering (APAC & Japan)",
    start_date: "2020-03",
    end_date: "2024-05"
  },
  "venture.nuvear": {
...
`
  ...
  "experience.capgemini-japan": {
    en: {
      ...
      frontmatter: {
        locale: "en",
        title: "Senior Director & Head of Digital Engineering at Capgemini Japan",
...
Served as Senior Director and Head of Digital Engineering for Capgemini Japan, scaling engineering capability, managing APAC delivery networks, and advising Japanese enterprise clients on digital and AI transformations.
